...
wcw_model_checkpoint = ModelCheckpoint(filepath='/Dataset/Model/Siamese_Diff_wCW.h5', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
...
cw_model_checkpoint = ModelCheckpoint(filepath='/Dataset/Model/Siamese_Diff_CW.h5', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
