...
wcw_model_checkpoint = ModelCheckpoint(filepath='/Dataset/Model/DNN_Diff_wCW.h5', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
...
cw_model_checkpoint = ModelCheckpoint(filepath='/Dataset/Model/DNN_Diff_CW.h5', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
...
cb_model_checkpoint = ModelCheckpoint(filepath='/Dataset/Model/DNN_Diff_CB.h5', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
...
for index in misclassified_indexes:
    ...
    misclassified_data.append([ denoised_image_name, patch_number, true_label, predicted_label, probability_non_ghosting, probability_ghosting ])

misclassified_df = pd.DataFrame(misclassified_data, columns=['Denoised Image Name', 'Patch Number', 'True Label', 'Predicted Label', 'Probability Non-Ghosting', 'Probability Ghosting'])
