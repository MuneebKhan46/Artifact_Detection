...
wcw_model_checkpoint = ModelCheckpoint(filepath='/Dataset/Model/DNN_SSIM_wCW.h5', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
...
cw_model_checkpoint = ModelCheckpoint(filepath='/Dataset/Model/DNN_SSIM_CW.h5', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
...
cb_model_checkpoint = ModelCheckpoint(filepath='/Dataset/Model/DNN_SSIM_CB.h5', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
...
misclass_wCW_csv_path = '/Dataset/CSV/DNN_SSIM_wCW_misclassified_patches.csv'
...
misclass_CW_csv_path  = '/Dataset/CSV/DNN_SSIM_CW_misclassified_patches.csv'    
...
misclass_CB_csv_path  = '/Dataset/CSV/DNN_SSIM_CB_misclassified_patches.csv'    
misclassified_indexes = np.where(predicted_labels != true_labels)[0]
misclassified_data = []
