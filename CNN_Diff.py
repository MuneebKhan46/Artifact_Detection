...
wcw_model_checkpoint = ModelCheckpoint(filepath='/Dataset/Model/CNN_Diff_wCW.h5', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
...
cw_model_checkpoint = ModelCheckpoint(filepath='/Dataset/Model/CNN_Diff_CW.h5', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
...
cb_model_checkpoint = ModelCheckpoint(filepath='/Dataset/Model/CNN_Diff_CB.h5', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
