...
wcw_model_checkpoint = ModelCheckpoint(filepath='/Dataset/Model/CNNsgd_AbsDiff_wCW.h5', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
...
cw_model_checkpoint = ModelCheckpoint(filepath='/Dataset/Model/CNNsgd_AbsDiff_CW.h5', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
...
cb_model_checkpoint = ModelCheckpoint(filepath='/Dataset/Model/CNNsgd_AbsDiff_CB.h5', save_best_only=True, monitor='val_accuracy', mode='max', verbose=1 )
...
misclass_wCW_csv_path = '/Dataset/CSV/CNNsgd_AbsDiff_wCW_misclassified_patches.csv'
...
misclass_CW_csv_path  = '/Dataset/CSV/CNNsgd_AbsDiff_CW_misclassified_patches.csv'    
...
misclass_CB_csv_path  = '/Dataset/CSV/CNNsgd_AbsDiff_CB_misclassified_patches.csv'    
misclassified_indexes = np.where(predicted_labels != true_labels)[0]
misclassified_data = []
...
feature_name = "Absolute Difference Map"
technique = "Ensemble"
print(f"Accuracy: {test_acc:.4f} | Precison: {weighted_precision:.4f} | Recall: {weighted_recall:.4f} | F1-score: {weighted_f1_score:.4f} | Loss: {test_loss:.4f} | N.G.A Acc: {accuracy_0:.4f} |G.A Acc: {accuracy_1:.4f}")
save_metric_details(model_name, technique, feature_name, test_acc, weighted_precision, weighted_recall, weighted_f1_score, test_loss, accuracy_0, accuracy_1, result_file_path)
